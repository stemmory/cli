...
// mitigation - STEM-82 adversarial review finding 2). ⚠️ 0600 is a POSIX
...
// sensitive regardless of OS, don't rely on the file mode alone (finding 12).
 ...
 * anything is written (STEM-82 findings 7 and 10) - callers should run
 ...
 *   quoting the file's own content back at the caller (findings 4 and 9).
 */
